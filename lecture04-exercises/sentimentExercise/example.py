...
select_sentiment = lambda s: wordSentiment(s)
...
word_map = all_word.map(select_sentiment)

# TODO: HINT! Remove the rest of this code, and create and print the result by reducing the word_map with the operator "add"
word_reduce = word_map.reduce(lambda s, t: add(s, t))
print("HERHERHER ER SVARET  " + str(word_reduce))
